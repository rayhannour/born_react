            ...
            <div className="p-grid">
                <div className="p-col-12  p-lg-4">
                    <div className="p-grid">
                        <div className="p-col-6 ">
                            <span className="footer-menutitle">APPLICATIONS REALISEES</span>
                            <ul>
                ...
                <div className="p-col-12">
                    <div className="footer-bottom">
                        <h4>CGPR COVID-19 STATESTIQUE</h4>
                        <h6>CGPR Ⓒ مركز الإعلامية بمنوبة (مصلحة الدراسات و البرمجة و السلامة المعلوماتية)</h6>
                    </div>
