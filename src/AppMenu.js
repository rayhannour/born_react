    ...
    return (
        <div className={classNames('menu-wrapper', { 'layout-sidebar-active': props.sidebarActive })}
            ...
            <div style={{ alignItems: 'center', justifyContent: 'center', display: 'flex' }}>
                    <Button onClick={() => history.push('/')} label="الواجهة الرئيسيــــة" icon="pi pi-home" style={{ display: 'block', marginTop: '20px', marginLeft: '6px', width: '200px', height: '80px' }} ></Button>
           </div>
            </div>
        </div >
